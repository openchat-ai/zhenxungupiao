...
.PHONY: all merge bootstrap compiler stock stock-gui stock-gui-elf signal clean \
  research-walk research-verify research-oos research-xsec research-v2 research-v3 research-v4 research-v4-recent research-v5-compare research-v6-compare \
...
research-oos:
	@chmod +x scripts/backtest_oos.sh
	@./scripts/backtest_oos.sh

research-xsec:
	@chmod +x scripts/backtest_xsec.sh
	@./scripts/backtest_xsec.sh
